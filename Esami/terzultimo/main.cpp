...
{
  t = creaAlberoVuoto(); // in caso l'operazione di lettura sia eseguita pi� volte (abbiamo memory leak)
  ...
  ifstream ifs(nome_file); // apertura di uno stream associato ad un file, in lettura
